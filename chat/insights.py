...
TOOL_SERVICES = {
    ...
    # Wren reading Wren: config/settings.json for describe_setup, and the docs
    # corpus for the other two — this repo's README/ANALYSIS/docs plus the
    # Markdown of two SIBLING checkouts (the wiki engine and ScribeJay), read as
    # data and never imported. Files on this machine, not a hosted service —
    # same bucket as games and projects.
