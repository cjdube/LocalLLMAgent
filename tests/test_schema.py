...
# Keys that have a row but are not migrated to config.getenv yet. This list
# shrinks to empty over the migration commits; a key may leave it, never
# rejoin it.
_RAW_ENV_EXEMPT_KEYS = frozenset({
    "BRIEF_TO_EMAIL", "DEFAULT_LOCATION",
    "FLASK_SECRET_KEY", "GEMINI_API_KEY",
    "GOOGLE_API_KEY", "GOOGLE_CALENDAR_ID",
    "GOOGLE_CREDENTIALS_PATH", "GOOGLE_HTTP_TIMEOUT_S", "GOOGLE_OAUTH_PORT",
    "GOOGLE_TASKLIST_ID", "GOOGLE_TOKEN_PATH", "LEARNINGS_DIR",
    "MAIL_ACT_LABEL", "MAIL_BODY_CHAR_BUDGET", "MAIL_PUBSUB_PROJECT",
    "MAIL_PUBSUB_SUBSCRIPTION", "MAIL_PUBSUB_TOPIC", "MAIL_SEARCH_CHAR_BUDGET",
    "MAIL_THREAD_CHAR_BUDGET", "MAIL_WATCH_LABEL", "NTFY_TOKEN", "NTFY_URL",
    "OLLAMA_HOST", "OLLAMA_KEEP_ALIVE", "OLLAMA_MAX_TOOL_RESULT_CHARS",
    "OLLAMA_MODEL", "OLLAMA_NUM_CTX", "OLLAMA_NUM_PREDICT", "OLLAMA_TIMEOUT",
    "OLLAMA_WARM_TIMEOUT", "OPP_SCORE_THRESHOLD",
    "OPP_STALLED_DAYS", "OPP_STATES", "PROJECTS_DIR", "SYNTHESIS_DIR",
    "TIMEZONE", "WEB_FETCH_MAX_CHARS", "WEIGH_ANCHOR_DIR",
    "WEIGH_ANCHOR_PORT", "WIKI_VAULT_PATH", "WREN_BUILD_MODEL",
    "WREN_BUILD_REPO_ROOT", "WREN_BUILD_TIMEOUT_S", "WREN_BUILD_WORKTREE_ROOT",
    "WREN_CHAT_BUSY_PROBE", "WREN_CHAT_BUSY_PROBE_TIMEOUT", "WREN_CHAT_HOST",
    "WREN_CHAT_MAX_HISTORY_CHARS", "WREN_CHAT_MODEL_TIMEOUT",
    "WREN_CHAT_PORT", "WREN_CHAT_SUMMARY_CHARS", "WREN_CHAT_TOKEN",
    "WREN_CLAUDE_BIN", "WREN_CLAUDE_PLANS_ROOT", "WREN_CLAUDE_PROJECTS_ROOT",
    "WREN_ESCALATION_BACKEND", "WREN_EXTERNAL_TASK_ROOTS",
    "WREN_GEMINI_MAX_OUTPUT_TOKENS", "WREN_GEMINI_MODEL",
    "WREN_GEMINI_THINKING_BUDGET", "WREN_LLM_BACKEND", "WREN_LOGS_DIR",
    "WREN_PUBLIC_URL", "WREN_RESEARCH_MODEL_TIMEOUT", "WREN_SKILLS_DIR",
    "WREN_USAGE_MAX_BYTES", "WREN_USAGE_RETENTION_DAYS", "WREN_WIKI_LINT_ROOT",
})
